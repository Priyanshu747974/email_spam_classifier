...
file = "C:\Users\Priya\Downloads\projects\Email-Spam-Detection-System\Project\Datasets\spam.csv"
...
class SpamHam:
    ...
    def main_window(self):
        ...
        head_label = Label(self.window, bg="#FFA500", fg="#000", text="Welcome to ESC", font=FONT_BOLD % (14), pady=10)
